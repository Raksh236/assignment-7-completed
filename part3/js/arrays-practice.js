...
movies3[3] = "Arrival";
movies3[4] = "Spirited Away";
movies3.splice(2, 0, "Parasite");
...
for (const idx in movies5) {
  console.log(movies5[idx]);
}
const sorted7 = [...movies5].sort();
for (const i in sorted7) {
  console.log(sorted7[i]);
}
const leastFavMovies = ["Movie 43", "Dragonball Evolution", "Cats (2019)"];
console.log("Movies I like:\n");
for (const m of movies5) console.log(m);
console.log("\nMovies I regret watching:\n");
for (const m of leastFavMovies) console.log(m);
let movies = movies5.concat(leastFavMovies);
console.log(movies.sort().reverse());
const lastItem = movies.at(-1);
